exports.run = async (client, message, args) => {
   ...
   if(!summary.price_overview.discount_percent) {
    ...
    message.channel.send({embed : embed1, translate: true, lang: "pt"})
   } else {
   ...
   .addField(':money_with_wings: Detalhes por preço', "Desconto de: "+summary.price_overview.discount_percent+"%")
   .setImage(summary.header_image)
   message.channel.send({embed : embed, translate: true, lang: "pt"}).catch(message.reply("<:err:449743511391305748> **|** Insira o ID de algum jogo steam. store.steampowered.com/app/**322330**\n322330 seria o steam do jogo Don't Starve Together."))
