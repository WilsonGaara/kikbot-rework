...
if(fala == null) fala.replace('null', 'https://cdn.discordapp.com/icons/449268692639809555/742f097d2915a490982fc82d6fc6edd8.jpg')
							...
							.addField(`👥 Membros (${message.guild.memberCount})`, `<:on:464117070594965506> **Online:** ${message.guild.presences.filter(channel => channel.status == 'online').size} <:idle:464117217102004224> **Ausente:** ${message.guild.presences.filter(channel => channel.status == 'idle').size} <:dnd:464117341160996874> **Ocupado:** ${message.guild.presences.filter(channel => channel.status == 'dnd').size} <:off:464117482513498112> **Offline:** ${message.guild.members.filter(member => member.user.presence.status === 'offline').size}\n🙋 **Pessoas:** ${message.guild.memberCount - message.guild.members.filter(member => member.user.bot).size}\n🤖 **Robôs:** ${message.guild.members.filter(member => member.user.bot).size}`, true)
							.setColor('BLUE')
...
if(fala2 == null) fala.replace('null', 'https://cdn.discordapp.com/icons/449268692639809555/742f097d2915a490982fc82d6fc6edd8.jpg')
						...
						.addField(`👥 Membros (${client.guilds.get(args[0]).memberCount})`, `<:on:464117070594965506> **Online:** ${client.guilds.get(args[0]).presences.filter(channel => channel.status == 'online').size} <:idle:464117217102004224> **Ausente:** ${client.guilds.get(args[0]).presences.filter(channel => channel.status == 'idle').size} <:dnd:464117341160996874> **Ocupado:** ${client.guilds.get(args[0]).presences.filter(channel => channel.status == 'dnd').size} <:off:464117482513498112> **Offline:** ${client.guilds.get(args[0]).members.filter(member => member.user.presence.status === 'offline').size}\n🙋 **Pessoas:** ${client.guilds.get(args[0]).memberCount - client.guilds.get(args[0]).members.filter(member => member.user.bot).size}\n🤖 **Robôs:** ${client.guilds.get(args[0]).members.filter(member => member.user.bot).size}`, true)
						.setColor('BLUE')
