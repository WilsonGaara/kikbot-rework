exports.run = (client, message, args)  => {
  ...
  if(!argns.size < 1) return message.reply(`Espero que você esteja cansado(a) de tanto digitar... `)
	message.react(`🎱`)
	var texto = ['Eu tenho uma pequena certeza que sim.', 'Não, acho que não viu.', 'Como assim? Tente denovo', 'Alô?! TERRA?!', 'Hmm, acho que sim em!', 'Acho que não...', 'Ahh! Pergunte pra outro', 'Sua vida é tão ruim assim?!']
